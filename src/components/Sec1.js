    ...
    <section className="container">
      <div className="sec1">
        ...
        <div className="text">
          ...
          knows no limits. With us, you'll enter a realm of endless innovation,
          where your imagination is the only constraint. Embrace a future
          without boundaries – that's our promise.
        </div>
      </div>
    </section>
  );
